                  ...
                  >
                    <div className="space-y-3">
                      <div className="flex items-center justify-between gap-4 font-mono text-[9px] uppercase tracking-wider text-neutral-400">
                        <span className="flex items-center gap-1"><Calendar size={10} /> {formatDate(issue.created_at)}</span>
                        <span className="flex items-center gap-1">#{issue.number} by {issue.user.login}</span>
                      </div>
                      <div>
                      ...
                      {issue.labels.length > 0 && (
                        <div className="flex flex-wrap gap-1.5 mt-2">
                          {issue.labels.map((lbl) => (
                            <span key={lbl.name} className="font-mono text-[8px] uppercase tracking-wider bg-neutral-200/50 dark:bg-neutral-800/50 text-neutral-500 dark:text-neutral-400 px-2 py-0.5 rounded-full">{lbl.name}</span>
                          ))}
                        </div>
                      )}
                    </div>
